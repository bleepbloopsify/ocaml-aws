...
module Metrics =
  struct
    ...
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Util.option_map v.event_threshold
              (fun f ->
                 Query.Pair
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.event_threshold
              (fun f -> ("event_threshold", (ReplicationTimeValue.to_json f)));
    ...
    let of_json j =
      {
        ...
        event_threshold =
          (Util.option_map (Json.lookup j "event_threshold")
      ...
      Some
        {
          ...
          replica_modifications =
            (Util.option_bind (Xml.member "ReplicaModifications" xml)
               ReplicaModifications.parse)
        }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Util.option_map v.replica_modifications
              (fun f ->
                 Query.Pair
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.replica_modifications
              (fun f ->
                 ("replica_modifications", (ReplicaModifications.to_json f)));
           Util.option_map v.sse_kms_encrypted_objects
             (fun f ->
                ("sse_kms_encrypted_objects",
    ...
    let of_json j =
      {
        ...
        replica_modifications =
          (Util.option_map (Json.lookup j "replica_modifications")
      ...
      Some
        {
          ...
          access_tier =
            (Xml.required "AccessTier"
               (Util.option_bind (Xml.member "AccessTier" xml)
    ...
    let of_json j =
      {
        ...
        access_tier =
          (IntelligentTieringAccessTier.of_json
             (Util.of_option_exn (Json.lookup j "access_tier")))
      }
  end
      ...
      Some
        {
          ...
          tags =
            (Util.of_option []
               (Util.option_bind (Xml.member "Tag" xml) TagSet.parse));
          access_point_arn =
            (Util.option_bind (Xml.member "AccessPointArn" xml) String.parse)
        }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Util.option_map v.access_point_arn
              (fun f -> Query.Pair ("AccessPointArn", (String.to_query f)));
           Some (Query.Pair ("Tag", (TagSet.to_query v.tags)));
           Util.option_map v.prefix
             (fun f -> Query.Pair ("Prefix", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.access_point_arn
              (fun f -> ("access_point_arn", (String.to_json f)));
           Some ("tags", (TagSet.to_json v.tags));
           Util.option_map v.prefix (fun f -> ("prefix", (String.to_json f)))])
    let of_json j =
      {
        ...
        tags = (TagSet.of_json (Util.of_option_exn (Json.lookup j "tags")));
        access_point_arn =
          (Util.option_map (Json.lookup j "access_point_arn") String.of_json)
      }
  end
module TargetGrant =
  struct
  ...
  struct
      ...
      Some
        {
          ...
          bucket_key_enabled =
            (Util.option_bind (Xml.member "BucketKeyEnabled" xml)
               Boolean.parse)
        }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Util.option_map v.bucket_key_enabled
              (fun f -> Query.Pair ("BucketKeyEnabled", (Boolean.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.bucket_key_enabled
              (fun f -> ("bucket_key_enabled", (Boolean.to_json f)));
           Util.option_map v.apply_server_side_encryption_by_default
             (fun f ->
                ("apply_server_side_encryption_by_default",
    ...
    let of_json j =
      {
        ...
        bucket_key_enabled =
          (Util.option_map (Json.lookup j "bucket_key_enabled")
             Boolean.of_json)
      }
  end
module Rule =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          object_ownership =
            (Xml.required "ObjectOwnership"
               (Util.option_bind (Xml.member "ObjectOwnership" xml)
    ...
    let of_json j =
      {
        object_ownership =
          (ObjectOwnership.of_json
             (Util.of_option_exn (Json.lookup j "object_ownership")))
      }
  end
  ...
  struct
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.and_
              (fun f -> ("and_", (IntelligentTieringAndOperator.to_json f)));
           Util.option_map v.tag (fun f -> ("tag", (Tag.to_json f)));
           Util.option_map v.prefix (fun f -> ("prefix", (String.to_json f)))])
    let of_json j =
      {
...
module TieringList =
  struct
    ...
    let make elems () = elems
    let parse xml =
      Util.option_all (List.map Tiering.parse (Xml.members "member" xml))
    let to_query v = Query.to_query_list Tiering.to_query v
    let to_json v = `List (List.map Tiering.to_json v)
    let of_json j = Json.to_list Tiering.of_json j
  end
...
module OwnershipControlsRules =
  struct
    ...
    let parse xml =
      Util.option_all
        (List.map OwnershipControlsRule.parse (Xml.members "member" xml))
    let to_query v = Query.to_query_list OwnershipControlsRule.to_query v
    let to_json v = `List (List.map OwnershipControlsRule.to_json v)
    let of_json j = Json.to_list OwnershipControlsRule.of_json j
  end
      ...
      Some
        {
          ...
          tierings = (Xml.required "Tiering" (TieringList.parse xml))
        }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Some (Query.Pair ("Tiering", (TieringList.to_query v.tierings)));
           Some
             (Query.Pair
                ("Status", (IntelligentTieringStatus.to_query v.status)));
           Util.option_map v.filter
             (fun f ->
                Query.Pair ("Filter", (IntelligentTieringFilter.to_query f)));
           Some (Query.Pair ("Id", (String.to_query v.id)))])
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Some ("tierings", (TieringList.to_json v.tierings));
    ...
    let of_json j =
      {
        ...
        tierings =
          (TieringList.of_json
             (Util.of_option_exn (Json.lookup j "tierings")))
      }
  end
...
module OwnershipControls =
  struct
    ...
    let parse xml =
      Some
        { rules = (Xml.required "Rule" (OwnershipControlsRules.parse xml)) }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Some
              (Query.Pair ("Rule", (OwnershipControlsRules.to_query v.rules)))])
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Some ("rules", (OwnershipControlsRules.to_json v.rules))])
    let of_json j =
      {
        rules =
    ...
    let parse xml =
      Util.option_all
        (List.map IntelligentTieringConfiguration.parse
           (Xml.members "member" xml))
    let to_query v =
      Query.to_query_list IntelligentTieringConfiguration.to_query v
    let to_json v =
      `List (List.map IntelligentTieringConfiguration.to_json v)
    let of_json j = Json.to_list IntelligentTieringConfiguration.of_json j
  end
module Delete =
  struct
    type t = {
      ...
      Some
        {
          ...
          expected_bucket_owner =
            (Util.option_bind (Xml.member "x-amz-expected-bucket-owner" xml)
               String.parse);
          request_payer =
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           ...
           Util.option_map v.expected_bucket_owner
             (fun f -> ("expected_bucket_owner", (String.to_json f)));
           Util.option_map v.version_id
             (fun f -> ("version_id", (String.to_json f)));
           Some ("key", (String.to_json v.key));
           Some ("bucket", (String.to_json v.bucket))])
    let of_json j =
      {
        ...
        version_id =
          (Util.option_map (Json.lookup j "version_id") String.of_json);
        expected_bucket_owner =
          (Util.option_map (Json.lookup j "expected_bucket_owner")
             String.of_json);
        request_payer =
      ...
      Some
        {
          ...
          bucket_key_enabled =
            (Util.option_bind
               (Xml.member "x-amz-server-side-encryption-bucket-key-enabled"
                  xml) Boolean.parse);
          request_charged =
            (Util.option_bind (Xml.member "x-amz-request-charged" xml)
               RequestCharged.parse)
...
module PutBucketLifecycleRequest =
  struct
    ...
    let make ~bucket  ?content_m_d5  ?lifecycle_configuration 
      ?expected_bucket_owner  () =
      { bucket; content_m_d5; lifecycle_configuration; expected_bucket_owner
      }
    let parse xml =
      Some
        {
  ...
  struct
    ...
    let parse xml =
      Some
        {
          ownership_controls =
            (Util.option_bind (Xml.member "OwnershipControls" xml)
               OwnershipControls.parse)
        }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Util.option_map v.ownership_controls
              (fun f ->
                 Query.Pair
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.ownership_controls
              (fun f -> ("ownership_controls", (OwnershipControls.to_json f)))])
    let of_json j =
      {
        ownership_controls =
          (Util.option_map (Json.lookup j "ownership_controls")
...
module ListPartsRequest =
  struct
    ...
    let make ~bucket  ~key  ?max_parts  ?part_number_marker  ~upload_id 
      ?request_payer  ?expected_bucket_owner  () =
      {
        bucket;
        key;
        max_parts;
      ...
      Some
        {
          ...
          expected_bucket_owner =
            (Util.option_bind (Xml.member "x-amz-expected-bucket-owner" xml)
               String.parse);
          ownership_controls =
            (Xml.required "OwnershipControls"
               (Util.option_bind (Xml.member "OwnershipControls" xml)
                  OwnershipControls.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        ...
        ownership_controls =
          (OwnershipControls.of_json
             (Util.of_option_exn (Json.lookup j "ownership_controls")))
      }
  end
module NoSuchBucket =
  struct
...
module WriteGetObjectResponseRequest =
  struct
    ...
    let make ~request_route  ~request_token  ?body  ?status_code  ?error_code
      ...
      ?content_type  ?delete_marker  ?e_tag  ?expires  ?expiration 
    ...
    let parse xml =
      Some
        {
          request_route =
            (Xml.required "x-amz-request-route"
               (Util.option_bind (Xml.member "x-amz-request-route" xml)
                  String.parse));
          request_token =
            (Xml.required "x-amz-request-token"
               (Util.option_bind (Xml.member "x-amz-request-token" xml)
                  String.parse));
          body = (Util.option_bind (Xml.member "Body" xml) Blob.parse);
          status_code =
            (Util.option_bind (Xml.member "x-amz-fwd-status" xml)
               Integer.parse);
          error_code =
            (Util.option_bind (Xml.member "x-amz-fwd-error-code" xml)
               String.parse);
          error_message =
            (Util.option_bind (Xml.member "x-amz-fwd-error-message" xml)
               String.parse);
          accept_ranges =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-accept-ranges" xml) String.parse);
          cache_control =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Cache-Control" xml) String.parse);
          content_disposition =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Content-Disposition" xml)
               String.parse);
          content_encoding =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Content-Encoding" xml)
               String.parse);
          content_language =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Content-Language" xml)
               String.parse);
          content_length =
            (Util.option_bind (Xml.member "Content-Length" xml) Long.parse);
          content_range =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Content-Range" xml) String.parse);
          content_type =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Content-Type" xml) String.parse);
          delete_marker =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-delete-marker" xml)
               Boolean.parse);
          e_tag =
            (Util.option_bind (Xml.member "x-amz-fwd-header-ETag" xml)
               String.parse);
          expires =
            (Util.option_bind (Xml.member "x-amz-fwd-header-Expires" xml)
               DateTime.parse);
          expiration =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-expiration" xml)
               String.parse);
          last_modified =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-Last-Modified" xml)
               DateTime.parse);
          missing_meta =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-missing-meta" xml)
               Integer.parse);
          metadata =
            (Util.option_bind (Xml.member "x-amz-meta-" xml) Metadata.parse);
          object_lock_mode =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-object-lock-mode" xml)
               ObjectLockMode.parse);
          object_lock_legal_hold_status =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-object-lock-legal-hold"
                  xml) ObjectLockLegalHoldStatus.parse);
          object_lock_retain_until_date =
            (Util.option_bind
               (Xml.member
          ...
          parts_count =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-mp-parts-count" xml)
               Integer.parse);
          replication_status =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-replication-status" xml)
               ReplicationStatus.parse);
          request_charged =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-request-charged" xml)
               RequestCharged.parse);
          restore =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-restore" xml) String.parse);
          server_side_encryption =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-server-side-encryption"
                  xml) ServerSideEncryption.parse);
          s_s_e_customer_algorithm =
            (Util.option_bind
               (Xml.member
          ...
          storage_class =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-storage-class" xml)
               StorageClass.parse);
          tag_count =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-tagging-count" xml)
               Integer.parse);
          version_id =
            (Util.option_bind
               (Xml.member "x-amz-fwd-header-x-amz-version-id" xml)
               String.parse);
          bucket_key_enabled =
            (Util.option_bind
               (Xml.member
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           ...
           Some ("request_token", (String.to_json v.request_token));
           Some ("request_route", (String.to_json v.request_route))])
    let of_json j =
      {
        request_route =
          (String.of_json
             (Util.of_option_exn (Json.lookup j "request_route")));
        request_token =
          (String.of_json
             (Util.of_option_exn (Json.lookup j "request_token")));
...
module PutObjectLockConfigurationRequest =
  struct
    ...
    let make ~bucket  ?object_lock_configuration  ?request_payer  ?token 
      ?content_m_d5  ?expected_bucket_owner  () =
      {
        bucket;
...
module PutObjectTaggingRequest =
  struct
    ...
    let make ~bucket  ~key  ?version_id  ?content_m_d5  ~tagging 
      ?expected_bucket_owner  ?request_payer  () =
      {
        bucket;
        key;
        version_id;
    ...
    let of_json j =
      {
        ...
        intelligent_tiering_configuration_list =
          (IntelligentTieringConfigurationList.of_json
             (Util.of_option_exn
                (Json.lookup j "intelligent_tiering_configuration_list")))
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          expected_source_bucket_owner =
            (Util.option_bind
               (Xml.member "x-amz-source-expected-bucket-owner" xml)
               String.parse)
        }
    let to_query v =
      Query.List
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.expected_source_bucket_owner
              (fun f -> ("expected_source_bucket_owner", (String.to_json f)));
           Util.option_map v.expected_bucket_owner
             (fun f -> ("expected_bucket_owner", (String.to_json f)));
           Util.option_map v.request_payer
             (fun f -> ("request_payer", (RequestPayer.to_json f)));
    ...
    let of_json j =
      {
        ...
        expected_bucket_owner =
          (Util.option_map (Json.lookup j "expected_bucket_owner")
             String.of_json);
        expected_source_bucket_owner =
          (Util.option_map (Json.lookup j "expected_source_bucket_owner")
             String.of_json)
      }
  end
...
module PutBucketWebsiteRequest =
  struct
    ...
    let make ~bucket  ?content_m_d5  ~website_configuration 
      ?expected_bucket_owner  () =
      { bucket; content_m_d5; website_configuration; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
...
module PutBucketCorsRequest =
  struct
    ...
    let make ~bucket  ~c_o_r_s_configuration  ?content_m_d5 
      ?expected_bucket_owner  () =
      { bucket; c_o_r_s_configuration; content_m_d5; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
  ...
  struct
    ...
    let make ?delete_marker  ?accept_ranges  ?expiration  ?restore 
      ?archive_status  ?last_modified  ?content_length  ?e_tag  ?missing_meta
       ?version_id  ?cache_control  ?content_disposition  ?content_encoding 
      ?content_language  ?content_type  ?expires  ?website_redirect_location 
      ?server_side_encryption  ?metadata  ?s_s_e_customer_algorithm 
      ?s_s_e_customer_key_m_d5  ?s_s_e_k_m_s_key_id  ?bucket_key_enabled 
      ?storage_class  ?request_charged  ?replication_status  ?parts_count 
      ?object_lock_mode  ?object_lock_retain_until_date 
      ?object_lock_legal_hold_status  () =
      {
        delete_marker;
      ...
      Some
        {
          ...
          archive_status =
            (Util.option_bind (Xml.member "x-amz-archive-status" xml)
               ArchiveStatus.parse);
          last_modified =
      ...
      `Assoc
        (Util.list_filter_opt
           ...
           Util.option_map v.last_modified
             (fun f -> ("last_modified", (DateTime.to_json f)));
           Util.option_map v.archive_status
             (fun f -> ("archive_status", (ArchiveStatus.to_json f)));
           Util.option_map v.restore
             (fun f -> ("restore", (String.to_json f)));
           Util.option_map v.expiration
             (fun f -> ("expiration", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        restore = (Util.option_map (Json.lookup j "restore") String.of_json);
        archive_status =
          (Util.option_map (Json.lookup j "archive_status")
...
module PutBucketAccelerateConfigurationRequest =
  struct
    ...
    let make ~bucket  ~accelerate_configuration  ?expected_bucket_owner  () =
      { bucket; accelerate_configuration; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
...
module PutBucketLoggingRequest =
  struct
    ...
    let make ~bucket  ~bucket_logging_status  ?content_m_d5 
      ?expected_bucket_owner  () =
      { bucket; bucket_logging_status; content_m_d5; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
    ...
    let to_json v =
      `Assoc
        (Util.list_filter_opt
           [Util.option_map v.access_tier
              (fun f ->
                 ("access_tier", (IntelligentTieringAccessTier.to_json f)));
           Util.option_map v.storage_class
             (fun f -> ("storage_class", (StorageClass.to_json f)))])
    let of_json j =
      {
        storage_class =
          (Util.option_map (Json.lookup j "storage_class")
             StorageClass.of_json);
        access_tier =
          (Util.option_map (Json.lookup j "access_tier")
             IntelligentTieringAccessTier.of_json)
      }
  end
      ...
      Some
        {
          intelligent_tiering_configuration =
            (Util.option_bind
               (Xml.member "IntelligentTieringConfiguration" xml)
               IntelligentTieringConfiguration.parse)
        }
    let to_query v =
      Query.List
        (Util.list_filter_opt
           [Util.option_map v.intelligent_tiering_configuration
              (fun f ->
                 Query.Pair
                   ("IntelligentTieringConfiguration",
    ...
    let of_json j =
      {
        intelligent_tiering_configuration =
          (Util.option_map
             (Json.lookup j "intelligent_tiering_configuration")
      ...
      Some
        {
          ...
          id =
            (Xml.required "id"
               (Util.option_bind (Xml.member "id" xml) String.parse));
          intelligent_tiering_configuration =
            (Xml.required "IntelligentTieringConfiguration"
               (Util.option_bind
                  (Xml.member "IntelligentTieringConfiguration" xml)
                  IntelligentTieringConfiguration.parse))
        }
...
module PutBucketAclRequest =
  struct
    ...
    let make ?a_c_l  ?access_control_policy  ~bucket  ?content_m_d5 
      ?grant_full_control  ?grant_read  ?grant_read_a_c_p  ?grant_write 
      ?grant_write_a_c_p  ?expected_bucket_owner  () =
      {
        a_c_l;
        access_control_policy;
        bucket;
...
module PutBucketLifecycleConfigurationRequest =
  struct
    type t =
      ...
      expected_bucket_owner: String.t option }
    let make ~bucket  ?lifecycle_configuration  ?expected_bucket_owner  () =
      { bucket; lifecycle_configuration; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
...
module ListObjectVersionsRequest =
  struct
    ...
    let make ~bucket  ?delimiter  ?encoding_type  ?key_marker  ?max_keys 
      ?prefix  ?version_id_marker  ?expected_bucket_owner  () =
      {
        bucket;
        delimiter;
        encoding_type;
...
module PutBucketTaggingRequest =
  struct
    type t =
      ...
      tagging: Tagging.t ;
      expected_bucket_owner: String.t option }
    let make ~bucket  ?content_m_d5  ~tagging  ?expected_bucket_owner  () =
      { bucket; content_m_d5; tagging; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
...
module PutObjectRetentionRequest =
  struct
    ...
    let make ~bucket  ~key  ?retention  ?request_payer  ?version_id 
      ?bypass_governance_retention  ?content_m_d5  ?expected_bucket_owner  ()
      =
      {
        bucket;
        key;
...
module ListMultipartUploadsRequest =
  struct
    ...
    let make ~bucket  ?delimiter  ?encoding_type  ?key_marker  ?max_uploads 
      ?prefix  ?upload_id_marker  ?expected_bucket_owner  () =
      {
        bucket;
        delimiter;
        encoding_type;
...
module PutBucketNotificationConfigurationRequest =
  struct
    ...
    let make ~bucket  ~notification_configuration  ?expected_bucket_owner  ()
      = { bucket; notification_configuration; expected_bucket_owner }
    let parse xml =
      Some
        {
          bucket =
